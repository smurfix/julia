...
- `Nothing`, which denotes that no error should be thrown
...
!!! compat "Julia 1.11"
    Using `@test_throws Nothing expr` to test for no exception requires Julia v1.11 or later.
